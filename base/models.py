...
class Order(models.Model):
    ...
    serviceFee = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
...
class OrderItem(models.Model):
    ...
    price = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    image = models.CharField(max_length=75, null=True, blank=True)
    _id = models.AutoField(primary_key=True, editable=False)
...
class Address(models.Model):
    ...
    shipppingPrice = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    _id = models.AutoField(primary_key=True, editable=False)
